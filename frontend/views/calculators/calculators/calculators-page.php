            ...
            <div class="col-xxs-12 col-xs-12 col-md-4">
                <div class="time-calc-plate-middle">
                    <select name="time-method" id="selectID" class="form-control">
                        <option value="addition" <?php if ($calculators->time->timeMethod == 'addition') {
                            echo ' selected ';
                        } ?>><?= Yii::t('app', 'Addition') ?></option>
                        <option value="subtraction" <?php if ($calculators->time->timeMethod == 'subtraction') {
                            echo ' selected ';
                        } ?>><?= Yii::t('app', 'Subtraction') ?></option>
                        <option value="multiplication" <?php if ($calculators->time->timeMethod == 'multiplication') {
                            echo ' selected ';
                        } ?>><?= Yii::t('app', 'Multiplication') ?></option>
                        <option value="division" <?php if ($calculators->time->timeMethod == 'division') {
                            echo ' selected ';
    ...
    <div class="time-calc">
        ...
        <div class="time-calc-flex">
            <div class="col-xxs-12 col-xs-12 col-md-6">
                <div class="time-calc-plate">
                    <input name="first-value" class="conversion-input conversion-input-left" type="tel"
            ...
            <div class="col-xxs-12 col-xs-12 col-md-6">
                <div class="time-calc-plate">
                    <input name="second-value" class="conversion-input conversion-input-right" type="tel"
                           aria-label="Phone Number"
