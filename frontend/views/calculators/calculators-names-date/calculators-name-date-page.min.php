...
?><a name=time></a><h1 class=main-page-h1><?= Yii::$app->params['text']['h1'] ?></h1><hr><form><div class=date-calc><div class=date-calc-header><?= Yii::t('app', 'Days between dates calculator') ?></div><div class=date-calc-flex><div class="col-xxs-12 col-xs-6"><div class=date-calc-plate><?= \kartik\datetime\DateTimePicker::widget([
                        'name' => 'picker1',
                    ...
                    */
                    ?></div></div><?php endif; ?></div></form><hr><?php if ($calculators->names->calculators) : ?><div class="row rflex"><div class="col-xxs-12 plates"><div class=plate-long><a class=plate-a-margin href="/<?= Yii::$app->language ?>/calculators/"><?= Yii::t('app', 'Time calculator'); ?></a><?= ' / ' ?><a class=plate-a-margin href="/<?= Yii::$app->language ?>/calculators/names/date/"><?= Yii::t('app', 'Date calculator'); ?></a><?= ' / ' ?><?php foreach ($calculators->names->calculators as $key => $calculator): ?><a class=plate-a-margin href="/<?= Yii::$app->language ?>/calculators/names/<?= $calculator['url'] ?>/"><?= $calculator['name'] ?></a><?= ' / ' ?><?php endforeach ?></div></div></div><hr><?php endif; ?>