...
<?php if ($calculators->toTimeLinks) : ?>
    <div class="row rflex">
        <div class="col-xxs-12 plates">
            <div class="plate-long">
                <?php foreach ($calculators->toTimeLinks as $key => $link): ?>
                    <a class="plate-a-margin"
                       href="/<?= Yii::$app->language ?>/calculators/convert/<?= $calculators->current->calculator->calculator['url'] ?>/<?= $calculators->second->calculator->calculator['url'] ?>/<?= $link ?>/"><?= $link ?></a><?= ' / ' ?>
                <?php endforeach ?>
            </div>
        </div>
    </div>
    ...
    <div class="row rflex">
        <div class="col-xxs-12 plates">
            <div class="plate-long">
                <?php foreach ($calculators->toHowManyLinks as $key => $link): ?>
                    <a class="plate-a-margin"
                       href="/<?= Yii::$app->language ?>/calculators/convert/<?= $link['url'] ?>/">
