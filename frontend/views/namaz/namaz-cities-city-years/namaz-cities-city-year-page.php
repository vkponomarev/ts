...
<div class="row">
    <div class="col-xxs-12 col-xs-4 c-prev-next-left">
        ...
        <?php else: ?>
            <a href="/<?= Yii::$app->language ?>/namaz/cities/<?= $time->location->city->url ?>/years/<?= $date->year->previous ?>/">
                <?= $date->year->previous ?>
            </a>
        <?php endif; ?>
    ...
    <div class="col-xxs-12 col-xs-4 c-prev-next-right">
        ...
        <?php else: ?>
            <a href="/<?= Yii::$app->language ?>/namaz/cities/<?= $time->location->city->url ?>/years/<?= $date->year->next ?>/">
                <?= $date->year->next ?>
            </a>
        <?php endif; ?>
        ...
        <div class="col-xxs-12 col-xs-6 col-md-4 col-lg-3 namaz-month-day plates">
            <div class="plate-clock">
                ...
                <span class="namaz-month-day-time">
                    <?= $namaz->year->times[$dateChange->format('m') . '-' . $dateChange->format('d')]['Fajr'] ?>
                </span>
                <br>
                ...
                <br>
                <span class="namaz-month-day-time">
                    <?= $namaz->year->times[$dateChange->format('m') . '-' . $dateChange->format('d')]['Sunrise'] ?>
                </span>
                <br>
                <span class="namaz-month-day-time-name">
                <?= Yii::t('app', 'Sunrise') ?>
                ...
                <br>
                <span class="namaz-month-day-time">
                <?= $namaz->year->times[$dateChange->format('m') . '-' . $dateChange->format('d')]['Dhuhr'] ?><br>
                </span>
                <span class="namaz-month-day-time-name">
                <?= Yii::t('app', 'Dhuhr') ?>
                </span>
                <br>
                <span class="namaz-month-day-time">
                <?= $namaz->year->times[$dateChange->format('m') . '-' . $dateChange->format('d')]['Asr'] ?><br>
                </span>
                <span class="namaz-month-day-time-name">
                <?= Yii::t('app', 'Asr') ?>
                </span>
                <br>
                <span class="namaz-month-day-time">
                <?= $namaz->year->times[$dateChange->format('m') . '-' . $dateChange->format('d')]['Maghrib'] ?><br>
                </span>
                <span class="namaz-month-day-time-name">
                <?= Yii::t('app', 'Maghrib') ?>
                </span>
                <br>
                <span class="namaz-month-day-time">
                <?= $namaz->year->times[$dateChange->format('m') . '-' . $dateChange->format('d')]['Isha'] ?><br>
                </span>
                <span class="namaz-month-day-time-name">
                <?= Yii::t('app', 'Isha') ?>
                </span>
