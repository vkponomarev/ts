...
<div class="row">
    <div class="col-xs-12 plate-namaz-times-text">
        ...
        <div class="plate-namaz-digital-watch">
            <a href="/<?= Yii::$app->language ?>/time/cities/<?= $time->geoIP->city->url ?>/">
                <span id="timeOne" class="time-block">
                    <?= $time->geoIP->city->date->format('H:i:s') ?>
                </span>
            </a>
            <?=  ', ' ?>
        </div>
        ...
        <a href="/<?= Yii::$app->language ?>/namaz/cities/<?= $time->geoIP->city->url ?>/">
