...
<div style="width: 100%">
    ...
    <table class="cpdf-sp1-year">
        ...
        foreach ($calendarBySeasons['calendar'] as $months) :?>
            ...
            <tr>
                ...
                <td class="cpdf-sp1-td-month">
                    <table class="cpdf-sp1-month">
                        <tr class="cpdf-sp1-month-name-line">
                            <td class="cpdf-sp1-month-name-line-td" colspan="7">
            <span class="fa fa-calendar">
                        ...
                        <tr class="cpdf-sp1-week">

                            <?php for ($i = 1; $i <= 7; $i++): ?>
                                <td class="cpdf-sp1-day-name">
                        ...
                        <tr>
                            <td class="cpdf-sp1-week-line" colspan="7">
                            ...
                            <tr class="cpdf-sp1-week">
                                ...
                                <?php for ($i = 1; $i <= 5; $i++): ?>
                                    <?php if (isset($week[$i])): ?>
                                        ...
                                        if (false !== $key): ?>
                                            <td class="cpdf-sp1-day cpdf-sp1-day-holiday">
                                                <?= $week[$i]['monthDay']; ?>
                                            </td>
                                        <?php else: ?>
                                            <td class="cpdf-sp1-day">
                                                <?= $week[$i]['monthDay']; ?>
                                            </td>
                                        <?php endif; ?>

                                    <?php else: ?>
                                        <td class="cpdf-sp1-no-day">
                            <span>
                            </span>
                                        </td>
                                    <?php endif; ?>
    ...
    <div class="cpdf-sp1-holidays-table-border">

        <table class="cpdf-sp1-holidays-table">
            <tr>
                <td>
                    <table class="cpdf-sp1-holidays-table-inside">
                        <?php
                        $count = 0;
                        ...
                        for ($i = $count; $i < $countHolidaysHalf; $i++) :
                            ...
                            ?>
                            <tr>
                                <td class="cpdf-sp1-holidays-name">
                                    <?= Yii::$app->formatter->asDate($dateFormat, 'medium'); ?>
                                </td>
                                <td class="cpdf-sp1-holidays-rounded-mark">
                                </td>
                                <td class="cpdf-sp1-holidays-name">
                                    <?= $holidaysData[$i]['name']; ?>
                                </td>
