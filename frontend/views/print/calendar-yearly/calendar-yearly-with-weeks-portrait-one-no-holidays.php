...
<br>
<table class="cpdf-ypww1-nh-year">
    ...
    foreach ($calendarByYear as $months) :?>
        ...
        <td class="cpdf-ypww1-nh-td-month">
            <table class="cpdf-ypww1-nh-month">
                <tr class="cpdf-ypww1-nh-month-name-line">
                    <td class="cpdf-ypww1-nh-month-name-line-td" colspan="8">
            <span class="fa fa-calendar">
                ...
                <tr class="cpdf-ypww1-nh-week">
                    <td class="">
                        #
                    </td>
                    <?php for ($i = 1; $i <= 7; $i++): ?>
                        <td class="cpdf-ypww1-nh-day-name">
                ...
                <tr>
                    <td class="cpdf-ypww1-nh-week-line" colspan="8">
                    ...
                    <tr class="cpdf-ypww1-nh-week">
                        ...
                        <?php for ($i = 1; $i <= 5; $i++): ?>
                            <?php if (isset($week[$i])): ?>
                                ...
                                if (false !== $key): ?>
                                    <td class="cpdf-ypww1-nh-day cpdf-ypww1-nh-day-holiday">
                                        <?= $week[$i]['monthDay']; ?>
                                    </td>
                                <?php else: ?>
                                    <td class="cpdf-ypww1-nh-day">
                        ...
                        <?php for ($i = 6; $i <= 7; $i++): ?>
                            <?php if (isset($week[$i])): ?>
                                <td class="cpdf-ypww1-nh-day-weekend">
                            <span>
                                <?= $week[$i]['monthDay']; ?>
                            </span>
                                </td>
