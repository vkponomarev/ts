...
<div style="width: 100%">
    ...
    <table class="cpdf-byp1-year">
        ...
        foreach ($calendarByYear['calendar'] as $months) :?>
            ...
            <td class="cpdf-byp1-td-month">
                <table class="cpdf-byp1-month">
                    <tr class="cpdf-byp1-month-name-line">
                        <td class="cpdf-byp1-month-name-line-td" colspan="8">
            <span class="fa fa-calendar">
                </span>
                            <a href="https://timesles.com/<?= Yii::$app->language ?>/calendar/business/months/<?= $dateData['year']['current']; ?>-<?= str_pad($countMonths, 2, '0', STR_PAD_LEFT) ?>/">
                                <?= $calendarNameOfMonths[$countMonths]; ?>
                            </a>
                        </td>
                    </tr>
                    <tr class="cpdf-byp1-week">
                        <td class="wday-name">
                            #
                        </td>
                        <?php for ($i = 1; $i <= 7; $i++): ?>
                            <td class="cpdf-byp1-day-name">
                    ...
                    <tr>
                        <td class="cpdf-byp1-week-line" colspan="8">
                    ...
                    <?php foreach ($months as $key => $week): ?>
                        ...
                        <tr class="cpdf-byp1-week">
                            ...
                            <span>
                                ...
                                <?php else: ?>
                                    <a class="cpdf-byl1-day" href="https://timesles.com/<?= Yii::$app->language ?>/calendar/weeks/<?= $dateData['year']['current'] ?>/<?= $key; ?>/">
                                        <?= $key; ?>
                                    </a>
                                <?php endif; ?>
                            </span>
                            ...
                            <?php for ($i = 1; $i <= 5; $i++): ?>
                                <?php if (isset($week[$i])): ?>
                                    ...
                                    if (false !== $key): ?>
                                        <td class="cpdf-byp1-day cpdf-byp1-day-holiday">
                                            <?= $week[$i]['monthDay']; ?>
                                        </td>
                                    <?php else: ?>
                                        <td class="cpdf-byp1-day">
                            ...
                            <?php for ($i = 6; $i <= 7; $i++): ?>
                                <?php if (isset($week[$i])): ?>
                                    ...
                                    <?php else: ?>
                                        <td class="cpdf-byp1-day-weekend">
                                            <?= $week[$i]['monthDay']; ?>
                                        </td>
                                    <?php endif; ?>
    ...
    <div>
        ...
        <?php foreach ($quarters as $one): ?>
                ...
                <table class="cpdf-byp1-table">
                    <tr class="business-gray">
                        <td class="cpdf-byp1-left" style="font-size: 10px">
                            <?= Yii::t('app', 'Calendar days') ?>
                        </td>
                        <td class="cpdf-byp1-right" style="font-size: 10px">
                            <?= $one['var']['days'] ?>
                        </td>
                    </tr>
                    <tr class="business-light">
     ...
     * ?>
     * <tr>
     * <td class="cpdf-byp1-holidays-name">
     * <?= Yii::$app->formatter->asDate($dateFormat, 'medium'); ?>
     * </td>
     * <td class="cpdf-byp1-holidays-rounded-mark">
     * </td>
     * <td class="cpdf-byp1-holidays-name">
     * <?= $holidaysData[$i]['name']; ?>
     * </td>
