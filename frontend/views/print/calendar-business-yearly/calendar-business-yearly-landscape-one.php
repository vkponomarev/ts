            ...
            <td class="calendar-pdf-header-table-left">
                <?php if (isset($getParamsCustomize['header']) && $getParamsCustomize['header'] <> ''): ?>
                    ...
                    <h2 class="calendar-pdf-header-h2">
                        <?= Yii::t('app', 'Business days calendar for {year}. ({country})', [
    ...
    <table style="width: 100%">
        <tr>
            <td style="width: 50%">
                <table class="cpdf-byl1-year">
                    ...
                    foreach ($calendarByYear['calendar'] as $months) :?>
                        ...
                        <td class="cpdf-byl1-td-month">
                            <table class="cpdf-byl1-month">
                                <tr class="cpdf-byl1-month-name-line">
                                    <td class="cpdf-byl1-month-name-line-td" colspan="8">
            <span class="fa fa-calendar">
                                ...
                                <tr class="cpdf-byl1-week">
                                    <td class="wday-name">
                                        #
                                    </td>
                                    <?php for ($i = 1; $i <= 7; $i++): ?>
                                        <td class="cpdf-byl1-day-name">
                                ...
                                <tr>
                                    <td class="cpdf-byl1-week-line" colspan="8">
                                ...
                                <?php foreach ($months as $key => $week): ?>
                                    ...
                                    <tr class="cpdf-byl1-week">
                                        ...
                                        <td class="cpdf-byp1-day">
                            <span>
                                <?php if ($countWeeks == 1 && $key > 50): ?>
                                    <a style="font-size: 10px"
                                       href="https://timesles.com/<?= Yii::$app->language ?>/calendar/weeks/<?= $dateData['year']['previous'] ?>/<?= $key; ?>/">
                                        <?= $key; ?>
                                    </a>
                                <?php else: ?>
                                    <a style="font-size: 10px"
                                       href="https://timesles.com/<?= Yii::$app->language ?>/calendar/weeks/<?= $dateData['year']['current'] ?>/<?= $key; ?>/">
                                        <?= $key; ?>
                                    </a>
                                <?php endif; ?>
                            </span>
                                        ...
                                        <?php for ($i = 1; $i <= 5; $i++): ?>
                                            <?php if (isset($week[$i])): ?>
                                                ...
                                                if (false !== $key): ?>
                                                    <td class="cpdf-byl1-day cpdf-byl1-day-holiday">
                                                        <?= $week[$i]['monthDay']; ?>
                                                    </td>
                                                <?php else: ?>
                                                    <td class="cpdf-byl1-day">
                                                        <?= $week[$i]['monthDay']; ?>
                                                    </td>
                                                <?php endif; ?>

                                            <?php else: ?>
                                                <td class="cpdf-byl1-no-day">
                            <span>
                            </span>
                                                </td>
                                            <?php endif; ?>
                                        ...
                                        <?php for ($i = 6; $i <= 7; $i++): ?>
                                            <?php if (isset($week[$i])): ?>
                                                ...
                                                <?php else: ?>
                                                    <td class="cpdf-byl1-day cpdf-byl1-day-weekend">
                                                        <?= $week[$i]['monthDay']; ?>
                                                    </td>
                                                <?php endif; ?>
            ...
            <td style="width: 50%;vertical-align: middle">
                ...
                <table style="width: 100%; font-size: 12px;">
                    <tr class="business-gray">
                        <td class="cpdf-byl1-td" rowspan="2" style="">
                            <?= Yii::t('app', 'Period') ?>
                        </td>
                        <td class="cpdf-byl1-td" colspan="3" style="text-align: center">
                            <?= Yii::t('app', 'Amount of days') ?>
                        </td>
                        <td class="cpdf-byl1-td" colspan="3" style="text-align: center">
                            <?= Yii::t('app', 'Working hours per week') ?>
                        </td>
                    </tr>
                    <tr class="business-gray">
                        <td class="cpdf-byl1-td">
                    ...
                    <?php foreach (range(1, 12) as $oneMonth): ?>

                        <tr class="<?= (($oneMonth % 2) == 0) ? 'business-gray' : 'business-light' ?>">
                            <td class="cpdf-byl1-td" style="border-top: 1px solid #9c9c9c">
                                <?= $calendarNameOfMonths[$oneMonth] ?>
                            </td>
                            <td class="cpdf-byl1-td">
                                <?= $calendarByYear['daysInMonth'][$oneMonth] ?>
                            </td>
                            <td class="cpdf-byl1-td">
                                <?= $calendarByYear['workingDays'][$oneMonth] ?>
                            </td>
                            <td class="cpdf-byl1-td">
                                <?= $calendarByYear['allHolidays'][$oneMonth] ?>
                            </td>
                            <td class="cpdf-byl1-td">
                                <?= $calendarByYear['hours40'][$oneMonth] ?>
                            </td>
                            <td class="cpdf-byl1-td">
                                <?= $calendarByYear['hours36'][$oneMonth] ?>
                            </td>
                            <td class="cpdf-byl1-td">
                                <?= $calendarByYear['hours24'][$oneMonth] ?>
                            </td>
                        </tr>
                    <?php endforeach ?>
                    <?php $countQuarters = 0; ?>
                    <?php foreach ($quarters as $one): ?>
                        <?php $countQuarters++ ?>
                        <tr class="<?= (($countQuarters % 2) == 0) ? 'business-gray' : 'business-light' ?>">
                            <td class="cpdf-byl1-td" style="border-top: 1px solid #9c9c9c">
                                <?= $one['name'] ?>
                            </td>
                            <td class="cpdf-byl1-td">
                ...
                <table>
                    <tr>
                        <td style="border: 1px solid #9c9c9c; padding: 5px">
