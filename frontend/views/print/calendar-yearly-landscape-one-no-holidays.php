...
<table class="cpdf-yl1-nh-year">
    ...
    foreach ($calendarByYear as $months) :?>
        ...
        <td class="cpdf-yl1-nh-td-month">
            <table class="cpdf-yl1-nh-month">
                <tr class="cpdf-yl1-nh-month-name-line">
                    <td class="cpdf-yl1-nh-month-name-line-td" colspan="7">
            <span class="fa fa-calendar">
                ...
                <tr class="cpdf-yl1-nh-week">

                    <?php for ($i = 1; $i <= 7; $i++): ?>
                        <td class="cpdf-yl1-nh-day-name">
                ...
                <tr>
                    <td class="cpdf-yl1-nh-week-line" colspan="7">
                    ...
                    <tr class="cpdf-yl1-nh-week">
                        ...
                        <?php for ($i = 1; $i <= 5; $i++): ?>
                            <?php if (isset($week[$i])): ?>
                                ...
                                if (false !== $key): ?>
                                    <td class="cpdf-yl1-nh-day cpdf-yl1-nh-day-holiday">
                                        <?= $week[$i]['monthDay']; ?>
                                    </td>
                                <?php else: ?>
                                    <td class="cpdf-yl1-nh-day cpdf-yl1-nh-day">
                                        <?= $week[$i]['monthDay']; ?>
                                    </td>
                                <?php endif; ?>

                            <?php else: ?>
                                <td class="cpdf-yl1-nh-no-day">
                            <span>
                            </span>
                                </td>
                            <?php endif; ?>
                        ...
                        <?php for ($i = 6; $i <= 7; $i++): ?>
                            <?php if (isset($week[$i])): ?>
                                <td class="cpdf-yl1-nh-day-weekend">
                            <span>
                                <?= $week[$i]['monthDay']; ?>
                            </span>
                                </td>
