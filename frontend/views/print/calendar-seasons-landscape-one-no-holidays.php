            ...
            <td class="calendar-pdf-header-table-left">
                <?php if (isset($getParamsCustomize['header']) && $getParamsCustomize['header'] <> ''): ?>
                    ...
                    <h2 class="calendar-pdf-header-h2">
                        <?= Yii::t('app', 'Calendar {season} {year}.', [
    ...
    <table class="cpdf-sl1-nh-year">
        ...
        foreach ($calendarBySeasons['calendar'] as $months) :?>
            <?php $countMonths++; ?>
                ...
                <td class="cpdf-sl1-nh-td-month">
                    <table class="cpdf-sl1-nh-month">
                        <tr class="cpdf-sl1-nh-month-name-line">
                            <td class="cpdf-sl1-nh-month-name-line-td" colspan="7">
            <span class="fa fa-calendar">
                        ...
                        <tr class="cpdf-sl1-nh-week">

                            <?php for ($i = 1; $i <= 7; $i++): ?>
                                <td class="cpdf-sl1-nh-day-name">
                        ...
                        <tr>
                            <td class="cpdf-sl1-nh-week-line" colspan="7">
                            ...
                            <tr class="cpdf-sl1-nh-week">
                                ...
                                <?php for ($i = 1; $i <= 5; $i++): ?>
                                    <?php if (isset($week[$i])): ?>
                                        ...
                                        if (false !== $key): ?>
                                            <td class="cpdf-sl1-nh-day cpdf-sl1-nh-day-holiday">
                                                <?= $week[$i]['monthDay']; ?>
                                            </td>
                                        <?php else: ?>
                                            <td class="cpdf-sl1-nh-day">
                                                <?= $week[$i]['monthDay']; ?>
                                            </td>
                                        <?php endif; ?>

                                    <?php else: ?>
                                        <td class="cpdf-sl1-nh-no-day">
                            <span>
                            </span>
                                        </td>
                                    <?php endif; ?>
                                ...
                                <?php for ($i = 6; $i <= 7; $i++): ?>
                                    <?php if (isset($week[$i])): ?>
                                        ...
                                        <?php else: ?>
                                            <td class="cpdf-sl1-nh-day-weekend">
                                                <?= $week[$i]['monthDay']; ?>
                                            </td>
                                        <?php endif; ?>
