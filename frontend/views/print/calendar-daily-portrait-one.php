...
<?php foreach ($calendarByDays as $day): ?>
        ...
        <tr>
            <td class="calendar-pdf-header-table-left"
                ...
                <?php if (isset($getParamsCustomize['header']) && $getParamsCustomize['header'] <> ''): ?>
                    ...
                    <h2 class="calendar-pdf-header-h2"><?= $calendarNameOfDaysInWeek['large'][$weekDay] ?>&nbsp;<?= Yii::$app->formatter->asDate($day['date'], 'd MMMM') ?></h2>
                <?php else: ?>
    ...
    <table style="width: 100%; ">
        <tr>
            <td style="/*border: 1px solid black;*/ text-align: left">
                <table style="width: 100%;">
                    <tr>
                        <td style="/*border: 1px solid red;*/ text-align: left;height: 1350px;width: 650px;vertical-align: top;padding-right: 20px; ">
                            <table style="width: 100%;">
                                <?php for ($c = 6; $c <= 23; $c++): ?>
                                    <tr style="width: 100%;">
                                        <td style="text-align: left;padding:2px; font-size: 15px; color:#868686; vertical-align: middle; height:74px;
 border-bottom: 1px solid black;">
                        ...
                        <td style="/*border: 1px solid red;*/ width: 250px;vertical-align: top;padding-left: 20px; ">

                            <table style="width: 100%;">
                                <?php for ($c = 6; $c <= 19; $c++): ?>
                                    <tr style="width: 100%;">
                                        <td style="text-align: left;padding:2px; font-size: 15px; color:#868686; vertical-align: middle; height:74px;
 border-bottom: 1px solid black; width: 280px;">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" class="cpdf-dp1-calendar-month">
                                        <br>
                                        <?php
