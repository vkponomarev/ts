...
<table class="cpdf-2ml1-year">
    ...
    foreach ($calendarByYear as $months) :?>
        ...
        <?php if (($countMonths == 1) or ($countMonths == 3) or ($countMonths == 5)  or ($countMonths == 7)  or ($countMonths == 9)  or ($countMonths == 11)): ?>
            <tr>
        <?php endif; ?>


            <td class="cpdf-2ml1-td-month">
                <table class="cpdf-2ml1-month">
                    <tr class="cpdf-2ml1-month-name-line">
                        <td class="cpdf-2ml1-month-name-line-td" colspan="7">
            <span class="fa fa-calendar">
                </span>
                            <a href="/" class="cpdf-2ml1-month-name-a">
                                <?= $calendarNameOfMonths[$countMonths] . ' 2020'; ?>
                            </a>
                        </td>
                    </tr>
                    <tr class="cpdf-2ml1-week-day-name">

                        <?php for ($i = 1; $i <= 7; $i++): ?>
                            <td class="cpdf-2ml1-day-name">
                    ...
                    <?php foreach ($months as $week): ?>
                        <tr class="cpdf-2ml1-week">
                            ...
                            <?php for ($i = 1; $i <= 5; $i++): ?>
                                <?php if (isset($week[$i])): ?>
                                    ...
                                    if (false !== $key): ?>
                                        <td class="cpdf-2ml1-day cpdf-2ml1-day-holiday">
                                            <?= $week[$i]['monthDay']; ?>
                                        </td>
                                    <?php else: ?>
                                        <td class="cpdf-2ml1-day cpdf-2ml1-day">
                                            <?= $week[$i]['monthDay']; ?>
                                        </td>
                                    <?php endif; ?>

                                <?php else: ?>
                                    <td class="cpdf-2ml1-day cpdf-2ml1-no-day">
                            <span>
                            </span>
                                    </td>
                                <?php endif; ?>
                            ...
                            <?php for ($i = 6; $i <= 7; $i++): ?>
                                <?php if (isset($week[$i])): ?>
                                    <td class="cpdf-2ml1-day cpdf-2ml1-day-weekend">
                            <span>
                                <?= $week[$i]['monthDay']; ?>
                            </span>
                                    </td>
                        ...
                        <?php if (($countMonths == 2) or ($countMonths == 3) or ($countMonths == 6) or ($countMonths == 8) or ($countMonths == 10) or ($countMonths == 12)): ?>
                            </tr>
                        <?php endif; ?>
                    <?php endforeach; ?>
                </table>
...
<div class="cpdf-2ml1-holidays-table-border">

    <table class="cpdf-2ml1-holidays-table">
        <tr>
            <td>
                <table class="cpdf-2ml1-holidays-table-inside">
                    <?php
                    $count = 0;
                    ...
                    for ($i = $count; $i < $countHolidaysHalf; $i++) :
                        ...
                        ?>
                        <tr>
                            <td class="cpdf-2ml1-holidays-name">
                                <?= Yii::$app->formatter->asDate($dateFormat, 'medium'); ?>
                            </td>
                            <td class="cpdf-2ml1-holidays-rounded-mark">
                            </td>
                            <td class="cpdf-2ml1-holidays-name">
                                <?= $holidaysByCountryByYear[$i]['holidays_name']; ?>
                            </td>
