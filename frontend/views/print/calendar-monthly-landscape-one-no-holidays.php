...
<table class="cpdf-ml1-nh-year">
    ...
    foreach ($calendarByMonths as $months) :?>
        ...
        <tr>
            ...
            <td class="cpdf-ml1-nh-td-month">
                <table class="cpdf-ml1-nh-month">

                    <tr class="cpdf-ml1-nh-week-day-name">

                        <?php for ($i = 1; $i <= 7; $i++): ?>
                            <td class="cpdf-ml1-nh-day-name">
                    ...
                    <tr>
                        <td class="cpdf-ml1-nh-week-line" colspan="7">

                        </td>
                    </tr>

                    <?php foreach ($months as $week): ?>
                        <tr class="cpdf-ml1-nh-week">
                            ...
                            <?php for ($i = 1; $i <= 5; $i++): ?>
                                <?php if (isset($week[$i])): ?>
                                    ...
                                    if (false !== $key): ?>
                                        <td class="cpdf-ml1-nh-day cpdf-ml1-nh-day-holiday">
                                            <?= $week[$i]['monthDay']; ?>
                                        </td>
                                    <?php else: ?>
                                        <td class="cpdf-ml1-nh-day cpdf-ml1-nh-day">
                                            <?= $week[$i]['monthDay']; ?>
                                        </td>
                                    <?php endif; ?>

                                <?php else: ?>
                                    <td class="cpdf-ml1-nh-day cpdf-ml1-nh-no-day">
                            <span>
                            </span>
                                    </td>
                                <?php endif; ?>
                            ...
                            <?php for ($i = 6; $i <= 7; $i++): ?>
                                <?php if (isset($week[$i])): ?>
                                    <td class="cpdf-ml1-nh-day cpdf-ml1-nh-day-weekend">
                            <span>
                                <?= $week[$i]['monthDay']; ?>
                            </span>
                                    </td>
