...
?><a name="calendar-<?= $date->year->current ?>"></a><h1 class=main-page-h1><?= Yii::$app->params['text']['h1'] ?></h1><hr><div class=row><?php /***************************** */ ?><?php /***************************** Сегодняшний год*/ ?><?php /***************************** */ ?><div class="col-xxs-12 col-sm-6 col-xs-12 current-date"><div class=current-date-div><div class=current-date-one><div class=current-date-year><?= $date->year->current ?><br><span class=current-date-month><?= Yii::t('app', 'year'); ?></span></div></div><div class=current-date-text><?= Yii::$app->params['text']['text1'] ?></div></div></div><?php /***************************** */ ?><?php /***************************** Календарь на месяц с отмеченным текущим днем*/ ?><?php /***************************** */ ?><div class="col-xxs-12 col-sm-6 col-xs-12 plates"><div class=plate><div class=plate-header><a href="/<?= Yii::$app->language ?>/calendar/months/<?= $date->year->current ?>-<?= $date->month->current ?>/"class=c-month-name><?= $calendarNameOfMonths[$date->month->simple]; ?></a></div><div class=c-links-block><div class="col-xs-12 c-links-mp-months"><div class="row rflex year"><?php
                ...
                ]) ?></a></div></div><div class="col-xxs-12 col-sm-6 col-md-4 col-xs-6 day-plates"><div class=day-plate><a href="/<?= Yii::$app->language ?>/calendar/weeks/days/<?= ($dayNameURL <> '') ? $dayNameURL : $date->current ?>/"class=day-plate-header><?= Yii::t('app', 'What day of the week is {date}', [
                    'date' => ($dayNameURL <> '') ? Yii::t('app', $dayNameURL) : Yii::$app->formatter->asDate($date->current, 'medium')
                ]) ?></a><br><br><?= $calendarNameOfDaysInWeek['large'][$date->week->dayNumber] ?></div></div><div class="col-xxs-12 col-sm-6 col-md-4 col-xs-6 day-plates"><div class=day-plate><a href="/<?= Yii::$app->language ?>/calendar/zodiac/days/<?= ($dayNameURL <> '') ? $dayNameURL : $date->current ?>/"class=day-plate-header><?= ($dayNameURL <> '')
                    ...
                    ]) ?></a><br><br><a href="/<?= Yii::$app->language ?>/zodiac/<?= $zodiacs->urls->ids[$zodiacs->zodiac->id] ?>/"><?= $zodiacs->zodiac->nameCapital ?></a></div></div><div class="col-xxs-12 col-sm-6 col-md-4 col-xs-6 day-plates"><div class=day-plate><a href="/<?= Yii::$app->language ?>/calendar/moon/days/<?= ($dayNameURL <> '') ? $dayNameURL : $date->current ?>/"class=day-plate-header><?= ($dayNameURL <> '')
            ...
            ]) ?></div></div><div class="col-xxs-12 col-sm-6 col-md-4 col-xs-6 day-plates"><div class=day-plate><a href="/<?= Yii::$app->language ?>/calendar/moon/phases/days/<?= ($dayNameURL <> '') ? $dayNameURL : $date->current ?>/"class=day-plate-header><?= ($dayNameURL <> '')
