...
<div class="row rflex">
    ...
    <div class="col-xxs-12 col-xs-12 col-sm-4 col-md-4 plates">
    <div class="plate-clock">
        <div class="plate-clock-analog-watch">
            <div id="container">
                <div id="content">
                    <canvas id="1111" width="200" height="200">
                        <script type="text/javascript">
                            $(function () {
                                let <?= 'clock' . '1111' ?> =
                                new Clock(
        ...
        <div class="plate-clock-digital-watch">
            <span id="time<?= '1111' ?>">12:30:35</span>
        </div>
        ...
        <div class="plate-clock-date">
            <?= Yii::$app->formatter->asDate($time->location->city->date, 'long') ?>
        </div>
        <div class="plate-clock-utc">
            <span id="date<?= '1111' ?>"></span>
        </div>
    ...
    <div class="col-xxs-12 col-xs-12 col-sm-4 col-md-4 plates">
        <div class="plate-clock">
            <div class="plate-clock-analog-watch">
                <div id="container">
                    <div id="content">
                        <canvas id="2222" width="200" height="200">
                            <script type="text/javascript">
                                $(function () {
                                    let <?= 'clock' . '2222' ?> =
                                    new Clock(
            ...
            <div class="plate-clock-digital-watch">
                <span id="time<?= '2222' ?>">12:30:35</span>
            </div>
