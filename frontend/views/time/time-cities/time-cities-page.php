...
<div class="row rflex">
    ...
    <?php foreach ($time->location->cities->byPopulation->data as $key => $city): ?>
        ...
        <div class="col-xxs-12 col-xs-6 col-sm-4 col-md-3 plates">
            <div class="plate-clock-min">
                ...
                <div class="plate-clock-min-digital-watch">
                    <span id="time<?= $key ?>"><?= $city['date']->format('H:i:s') ?></span>
                </div>
...
<div class="row rflex">
    ...
    <?php foreach ($time->location->cities->byPopulationSecond->data as $key => $city): ?>
