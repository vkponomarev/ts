                        ...
                        $(function () {
                            let clock =
                                new ClockSecond({
                                    ...
                                    timeZoneTime: '',
                                    dateID: 'date',
                                    language: '<?= Yii::$app->language; ?>', timeZoneTimeUTC:<?= $time->timeZoneTime->current['offset'] / 60 ?>}); });*/ ?> <a name=time></a><h1 class=main-page-h1><?= Yii::$app->params['text']['h1'] ?></h1><hr><script>setInterval(
        function () {
