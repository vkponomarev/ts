...
<div class="row">
    ...
    <div class="col-xxs-12 col-xs-6 c-links-mp">
        ...
        <div class="c-links-block"><a href="/<?= Yii::$app->language ?>/calendar/religion/orthodox/years/<?= $date->year->current ?>/">
            <?= Yii::t('app', 'Orthodox calendar for {year}', ['year' => $date->year->current]) ?>
        </a>
        <br>

        <a href="/<?= Yii::$app->language ?>/calendar/religion/catholic/years/<?= $date->year->current ?>/">
            <?= Yii::t('app', 'Catholic calendar for {year}', ['year' => $date->year->current]) ?>
        </a>
        <br>
        <a href="/<?= Yii::$app->language ?>/calendar/religion/muslim/years/<?= $date->year->current ?>/">
            <?= Yii::t('app', 'Muslim calendar for {year}', ['year' => $date->year->current]) ?>
        </a>
        <br>
        <a href="/<?= Yii::$app->language ?>/calendar/religion/jewish/years/<?= $date->year->current ?>/">
            <?= Yii::t('app', 'Jewish calendar for {year}', ['year' => $date->year->current]) ?>
        </a>
        <br>

        <a href="/<?= Yii::$app->language ?>/calendar/religion/hindu/years/<?= $date->year->current ?>/">
            <?= Yii::t('app', 'Hindu calendar for {year}', ['year' => $date->year->current]) ?>
        </a>
        </div>
