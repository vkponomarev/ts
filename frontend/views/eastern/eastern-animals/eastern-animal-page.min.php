...
?><a name=calendar></a><h1 class=main-page-h1><?= Yii::$app->params['text']['h1'] ?></h1><hr><div class=row><?php /***************************** */ ?><?php /***************************** Сегодняшний год*/ ?><?php /***************************** */ ?><div class="col-xs-6 col-xxs-12 current-date"><div class=current-date-div><div class=current-date-one><div class=current-date-year><img alt="<?= Yii::$app->params['text']['h1'] ?>"class=eastern-pic src="/pictures/eastern-animals/<?= $eastern->animal->picture; ?>.png"width=80> <span class=current-date-month></span></div></div><div class=current-date-text><?= Yii::$app->params['text']['text1'] ?></div></div></div><div class="col-xs-6 col-xxs-12 c-links-mp"><div class=c-links-block><div class="col-xs-6 c-links-mp-months"><?php foreach (range(1, 6) as $id): ?><div><img alt="<?= $eastern->text->names[$id]; ?>"class=eastern-pic src="/pictures/eastern-animals/<?= $eastern->animals->pictures[$id]; ?>.png"width=30> <a href="/calendar/eastern/animals/<?= $eastern->animals->urls[$id] ?>/"><?= $eastern->text->names[$id]; ?></a></div><?php endforeach ?></div><div class="col-xs-6 c-links-mp-months"><?php foreach (range(7, 12) as $id): ?><div><img alt="<?= $eastern->text->names[$id]; ?>"class=eastern-pic src="/pictures/eastern-animals/<?= $eastern->animals->pictures[$id]; ?>.png"width=30> <a href="/calendar/eastern/animals/<?= $eastern->animals->urls[$id] ?>/"><?= $eastern->text->names[$id]; ?></a></div><?php endforeach ?></div></div></div></div><hr><br><div class="row rflex"><div class="col-xxs-12 eastern-year"><h2><?= Yii::t('app', '{animal} by Years of the Eastern Chinese Calendar', [
