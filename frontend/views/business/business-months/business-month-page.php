                ...
                <div class="plate-links">
                    <form method="get" id="form">
                        <div class="form-group">
                            <script>
                                let url = '<?php echo \yii\helpers\Url::home(true) . Yii::$app->language . '/calendar/business/months/' . $dateData['year']['current'] . '-' . $dateData['month']['number'] . '/';?>';
                            </script>
        ...
        <?php else: ?>
            ...
            <?php else: ?>
                <?php if ($dateData['month']['numberSimple'] == 1): ?>
                    <a href="/<?= Yii::$app->language ?>/calendar/business/months/<?= $dateData['year']['previous'] ?>-<?= str_pad(12, 2, '0', STR_PAD_LEFT) ?>/
            <?= (($countryURL['url'] <> '')
                ...
                <?php else: ?>
                    <a href="/<?= Yii::$app->language ?>/calendar/business/months/<?= $dateData['year']['current'] ?>-<?= str_pad($dateData['month']['numberSimple'] - 1, 2, '0', STR_PAD_LEFT) ?>/
            <?= (($countryURL['url'] <> '')
        ...
        <?php else: ?>
            ...
            <?php else: ?>
                <?php if ($dateData['month']['numberSimple'] == 12): ?>
                    <a href="/<?= Yii::$app->language ?>/calendar/business/months/<?= $dateData['year']['next'] ?>-<?= str_pad(1, 2, '0', STR_PAD_LEFT) ?>/
            <?= (($countryURL['url'] <> '')
...
<?php if ($holidaysData): ?>
    ...
    <h2 class="main-page-h1">
        <?= Yii::t('app', 'Business days calendar with holidays and weekends for {month} {year} {country_for}', [
