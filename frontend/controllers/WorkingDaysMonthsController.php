...
class WorkingDaysMonthsController extends Controller
{


    public function actionWorkingDaysMonthPage($monthURL, $countryURL)
    {


        $textID = '209'; // ID из таблицы pages
        ...
        */
        ...
        return $this->render('working-days-month-page.min.php', [
