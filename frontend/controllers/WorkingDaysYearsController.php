...
class WorkingDaysYearsController extends Controller
{

    public function actionWorkingDaysYearPage($yearURL, $countryURL)
    {
        ...
        */
        ...
        return $this->render('working-days-year-page.min.php', [
