...
class BusinessThirtyMonthsController extends Controller
{


    public function actionBusinessThirtyMonthPage($monthURL, $countryURL)
    {


        $textID = '217'; // ID из таблицы pages
        ...
        Yii::$app->params['breadcrumbs'] = $breadCrumbs->calendarBusinessThirtyMonths($dateDataObj, $countryURL['url'], $countryData);
