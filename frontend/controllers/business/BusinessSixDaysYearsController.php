...
class BusinessSixDaysYearsController extends Controller
{

    public function actionBusinessSixDaysYearPage($yearURL, $countryURL)
    {


        $textID = '212'; // ID из таблицы pages
        ...
        $calendarByYear = $calendar->byYearBusiness($year, $holidaysData,1);
        ...
        Yii::$app->params['breadcrumbs'] = $breadCrumbs->calendarBusinessSixDaysYears($dateDataObj, $countryURL['url'], $countryData);
        ...
        return $this->render('business-six-days-year-page.min.php', [
