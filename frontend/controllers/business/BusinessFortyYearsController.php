...
class BusinessFortyYearsController extends Controller
{

    public function actionBusinessFortyYearPage($yearURL, $countryURL)
    {


        $textID = '214'; // ID из таблицы pages
        ...
        Yii::$app->params['breadcrumbs'] = $breadCrumbs->calendarBusinessFortyYears($dateDataObj, $countryURL['url'], $countryData);
        ...
        return $this->render('business-forty-year-page.min.php', [
