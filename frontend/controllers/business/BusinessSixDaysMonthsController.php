...
class BusinessSixDaysMonthsController extends Controller
{


    public function actionBusinessSixDaysMonthPage($monthURL, $countryURL)
    {


        $textID = '213'; // ID из таблицы pages
        ...
        $calendarByMonth = $calendar->byMonthBusiness($monthURL, $holidaysData,1);
        ...
        Yii::$app->params['breadcrumbs'] = $breadCrumbs->calendarBusinessSixDaysMonths($dateDataObj, $countryURL['url'], $countryData);

        return $this->render('business-six-days-month-page.min.php', [
