...
class BusinessDaysOffYearsController extends Controller
{

    public function actionBusinessDaysOffYearPage($yearURL, $countryURL)
    {


        $textID = '210'; // ID из таблицы pages
        ...
        Yii::$app->params['breadcrumbs'] = $breadCrumbs->calendarBusinessDaysOffYears($dateDataObj, $countryURL['url'], $countryData);
        ...
        return $this->render('days-off-year-page.min.php', [
