...
class BusinessThirtyYearsController extends Controller
{

    public function actionBusinessThirtyYearPage($yearURL, $countryURL)
    {


        $textID = '216'; // ID из таблицы pages
        ...
        Yii::$app->params['breadcrumbs'] = $breadCrumbs->calendarBusinessThirtyYears($dateDataObj, $countryURL['url'], $countryData);
        ...
        return $this->render('business-thirty-year-page.min.php', [
