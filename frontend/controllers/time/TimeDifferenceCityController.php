...
class TimeDifferenceCityController extends Controller
{
     ...
     */
    public function actionTimeDifferenceCityPage($cityURL)
    {
        $yearURL = 2020;
        $countryURL = '';
        $textID = '295'; // ID из таблицы pages
        ...
        Yii::$app->params['breadcrumbs'] = (new BreadcrumbsTimeDifferenceCity())->breadcrumbs($time);

        return $this->render('time-difference-city-page.min.php', [
            'time' => $time,
            'date' => $date,
