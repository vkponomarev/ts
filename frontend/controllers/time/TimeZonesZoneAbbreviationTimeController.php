...
class TimeZonesZoneAbbreviationTimeController extends Controller
{
     ...
     */
    public function actionTimeZonesZoneAbbreviationTimePage($zoneURL, $zoneTime)
    {
        $zoneTime = urlencode($zoneTime);
        $textID = '287'; // ID из таблицы pages
        ...
        Yii::$app->params['breadcrumbs'] = (new BreadcrumbsTimeZonesZoneAbbreviationTime())->breadcrumbs($time);


        return $this->render('time-zones-zone-abbreviation-time-page.min.php', [
