...
use common\components\breadcrumbs\BreadcrumbsCalculatorsConvert;
...
class CalculatorsConvertController extends Controller
{
     ...
     */
    public function actionCalculatorsConvertPage($calcNameURL, $calcNameSecondURL)
    {

        $yearURL = 2020;
        $countryURL = '';
        $textID = 310; // ID из таблицы pages
        ...
        Yii::$app->params['breadcrumbs'] = (new BreadcrumbsCalculatorsConvert())->breadcrumbs($calculators);



        return $this->render('calculators-convert-page.min.php', [
