...
use common\components\breadcrumbs\BreadcrumbsCalculatorsConvertSomeTimeToTime;
...
use common\components\urlCheck\UrlCheckCalcNameSomeTime;
...
class CalculatorsConvertSomeTimeToTimeController extends Controller
{

    /**
     * @route /calculators/convert/calcNameURL/calcNameSecondURL/someTimeURL/
     * @return string
     * @throws \yii\web\NotFoundHttpException
     */
    public function actionCalculatorsConvertSomeTimeToTimePage($calcNameURL, $calcNameSecondURL, $someTimeURL)
    {

        $yearURL = 2020;
        $countryURL = '';
        $textID = 311; // ID из таблицы pages
        ...
        $calcTimesRange = new UrlCheckCalcNameSomeTime($calcNameURL, $calcNameSecondURL, $someTimeURL);
        ...
        $calculators = new Calculators([
            'calcName' => $calcNameURL,
            'calcNameSecond' => $calcNameSecondURL,
            'someTime' => $someTimeURL,
            'someTimeRange' => $calcTimesRange->range,
        ]);

        Yii::$app->params['breadcrumbs'] = (new BreadcrumbsCalculatorsConvertSomeTimeToTime())->breadcrumbs($calculators);



        return $this->render('calculators-convert-some-time-to-time-page.min.php', [
