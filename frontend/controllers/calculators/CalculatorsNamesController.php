...
use common\components\breadcrumbs\BreadcrumbsCalculatorsNames;
...
class CalculatorsNamesController extends Controller
{
     ...
     */
    public function actionCalculatorsNamePage($calcNameURL)
    {

        $yearURL = 2020;
        $countryURL = '';
        $textID = 309; // ID из таблицы pages
        ...
        Yii::$app->params['breadcrumbs'] = (new BreadcrumbsCalculatorsNames())->breadcrumbs();



        return $this->render('calculators-name-page.min.php', [
