...
use common\components\breadcrumbs\BreadcrumbsCalculators;
...
class CalculatorsController extends Controller
{
     ...
     */
    public function actionCalculatorsPage()
    {

        $yearURL = 2020;
        $countryURL = '';
        $textID = '304'; // ID из таблицы pages
        ...
        $calcNames = new UrlCheckCalcNames('minutes', 'seconds');
        ...
        Yii::$app->params['breadcrumbs'] = (new BreadcrumbsCalculators())->breadcrumbs();



        return $this->render('calculators-page.min.php', [
