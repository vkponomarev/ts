...
/**
 * HolidaysTextSearch represents the model behind the search form of `common\models\HolidaysText`.
 */
class HolidaysTextSearch extends HolidaysText
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'holidays_id', 'languages_id', 'active'], 'integer'],
