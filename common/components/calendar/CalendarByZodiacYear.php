...
class CalendarByZodiacYear
{

    public function calendar($year, $zodiacRange)
    {
        ...
        /*
                $zodiac[11]['start'] = $year + 1 . '-' . $zodiacRange[11]['start'];
                $zodiac[11]['end'] = $year + 1 . '-' . $zodiacRange[11]['end'];

                $zodiac[12]['start'] = $year + 1 . '-' . $zodiacRange[12]['start'];
                $zodiac[12]['end'] = $year + 1 . '-' . $zodiacRange[12]['end'];
        */
        /**
