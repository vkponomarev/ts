...

{
    ...
    public function update($pageTextsMessages, $dateData, $countryData, $holidaysCount)
    {
        ...
        */
        ...
        Yii::$app->params['text']['title'] = str_replace('{season}', $pageTextsMessages['seasonNow'], Yii::$app->params['text']['title']);
        ...
        Yii::$app->params['text']['h1'] = str_replace('{season}', $pageTextsMessages['seasonNow'], Yii::$app->params['text']['h1']);
        ...
        Yii::$app->params['text']['text1'] = str_replace('{country_for}', $countryData['name_for'], Yii::$app->params['text']['text1']);

        Yii::$app->params['text']['text1'] = str_replace('{holidays_count}', Yii::t('app', '{n,plural, one{# holiday and day off} few{# holidays and days off} other{# holidays and days off}}', ['n' => $holidaysCount]), Yii::$app->params['text']['text1']);
        ...
        Yii::$app->params['text']['text1'] = str_replace('{season_on}', $pageTextsMessages['seasonOn'], Yii::$app->params['text']['text1']);
