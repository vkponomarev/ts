...
class SiteMapGenerateCalculators__
{
        ...
        foreach ($times as $time) {
            ...
            foreach ($languagesData as $language) {
                ...
                foreach ($times as $time2) {
                    ...
                    $siteMapUrls .= \Yii::$app->view->render('@common/components/gii/siteMap/templates/_calculators-how-much.php', [
                        'language' => $language,
                        'time' => $time,
                        'time2' => $time2,
                    ]);
