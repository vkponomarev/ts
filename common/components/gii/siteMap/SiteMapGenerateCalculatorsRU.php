...
class SiteMapGenerateCalculatorsRU
{
                    ...
                    if ($timesConvertArray[$countTimes][$countTimes2]) {
                        ...
                        foreach ($timesConvertArray[$countTimes][$countTimes2] as $time3) {
                            ...
                            if (($countLimit >= 49990) or (
                                    ...
                                    ($countTimes3 == count($timesConvertArray[$countTimes][$countTimes2]))
                                )) {
                                ...
                                // Создаем файл
                                $gii = new Gii();
                                $fileName = 'sitemap_calculators_ru_' . $countFiles;
