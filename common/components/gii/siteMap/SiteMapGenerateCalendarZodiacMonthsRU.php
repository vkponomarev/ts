...
class SiteMapGenerateCalendarZodiacMonthsRU
{
        ...
        foreach (range(1, 9999) as $year) {
            ...
            foreach ($languagesData as $language) {
                ...
                foreach (range(1, 12) as $month) {
                    ...
                    $siteMapUrls .= \Yii::$app->view->render('@common/components/gii/siteMap/templates/_calendar-zodiac-months.php', [
                        'language' => $language,
                        'year' => $year,
                    ...
                    if (($countLimit >= 49998) or
                        ...
                        // Создаем файл
                        $gii = new Gii();
                        $fileName = 'sitemap_calendar_zodiac_months_ru_' . $countFiles;
