...
class SiteMapGenerateCalendarHolidaysMonthsRU
{
            ...
            foreach ($languagesData as $language) {
                ...
                foreach (range(1, 12) as $month) {
                    ...
                    foreach ($countriesData as $country) {
                        ...
                        if (($countLimit >= 49990) or (($year == $holidaysRange['end']) and ($countriesDataCount == $countCountry) and ($countMonths == 12))) {
                            ...
                            // Создаем файл
                            $gii = new Gii();
                            $fileName = 'sitemap_calendar_holidays_months_ru_' . $countFiles;
