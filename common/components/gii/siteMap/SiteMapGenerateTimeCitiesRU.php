...
class SiteMapGenerateTimeCitiesRU
{
    ...
    function generate($languagesData)
    {
        ...
        foreach ($cities as $city) {
            ...
            foreach ($languagesData as $language) {
                ...
                $siteMapUrls .= \Yii::$app->view->render('@common/components/gii/siteMap/templates/_time_cities.php', [
                    'language' => $language,
                    'city' => $city['url'],
                ]);
                ...
                if (($countLimit >= 49990) or (
                    ...
                    // Создаем файл
                    $gii = new Gii();
                    $fileName = 'sitemap_time_cities_ru_' . $countFiles;
